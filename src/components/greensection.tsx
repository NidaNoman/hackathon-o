// // components/GreenSection.tsx
// import React from "react";
// import Image from "next/image";

// const GreenSection = () => {
//   return (
//     <div className="bg-green-600 text-white py-16 px-8 flex flex-col md:flex-row items-center justify-between">
//       {/* Text Section */}
//       <div className="max-w-lg">
//         <h3 className="text-sm font-medium uppercase mb-2">Summer 2020</h3>
...
//           <span className="text-2xl font-semibold mr-4">$16.48</span>
//           <button className="bg-white text-green-600 px-6 py-2 rounded-md font-medium hover:bg-gray-200">
//             Add to Cart
//           </button>
//         </div>
//       </div>
...
//         <Image 
//           src="/green.png" // Replace this with the actual image path
  ...
  return (
    <div className="flex flex-col md:flex-row items-center bg-green-600 py-16 px-8 md:px-16 text-white mb-0">
      ...
      <div className="w-full md:w-1/2 mt-8 md:mt-0 flex justify-center">
        <Image
          src="/green.png" // Update with your image path
          alt="Product Image"
          width={400}
          height={400}
