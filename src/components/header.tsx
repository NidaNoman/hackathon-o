...
export default function Header() {
  return (
    <div>
      {/* Top Bar */}
      <div className="bg-[#252B42] text-white flex flex-col sm:flex-row justify-between items-center px-4 py-2 mb-0">
        {/* Phone Info */}
        ...
        {/* Follow Us Message */}
        <h6 className="hidden lg:block text-sm font-bold mb-2 sm:mb-0">
      ...
      <nav className="bg-white shadow-md">
        <div className="container mx-auto px-4 py-3 flex flex-wrap justify-between items-center">
          ...
          <div className="md:hidden flex items-center space-x-4">
            <button className="hover:underline text-sm">Menu</button>
          </div>
